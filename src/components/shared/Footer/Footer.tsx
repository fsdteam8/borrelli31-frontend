      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <p className="flex items-center gap-2 text-[#FFF]/75 text-base">
              <span>
                <svg
            ...
            <p className="flex items-center gap-2 text-[#FFF]/75 text-sm">
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="17"
        ...
        <div className="border-t border-[#D9D9D94D] mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <span className="text-base text-[#FFF]">
            © 2025 Borrelli Roofing. All rights reserved.
          </span>
